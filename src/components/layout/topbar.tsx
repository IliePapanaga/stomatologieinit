    ...
    <>
      <header className="sticky top-0 z-30 flex h-14 items-center gap-2 border-b border-border/60 bg-background/80 px-3 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 md:px-5">
        ...
        {impersonator && (
          <Badge
            variant="outline"
            className="ml-1 hidden md:flex gap-1.5 border-amber-500/40 bg-amber-500/10 text-amber-600 dark:text-amber-400"
          >
        ...
        <div className="ml-auto flex items-center gap-1 shrink-0">
          {impersonator && (
            <Button
              ...
              className="h-8 gap-1.5 px-2 md:px-3 border-amber-500/30 hover:bg-amber-500/10 text-amber-600 dark:text-amber-400"
            >
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {currentUser?.email ?? mockPractice.email}
                  </span>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
