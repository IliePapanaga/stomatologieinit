  ...
  return (
    <div className="flex min-h-[70svh] items-center justify-center p-6">
      <div className="max-w-sm text-center">
        ...
        <h1 className="mt-4 text-xl font-semibold tracking-tight">{t("certificates_title")}</h1>
        <p className="mt-2 text-sm text-muted-foreground">{t("documents_managed")}</p>
        <Button asChild className="mt-5">
          <Link to="/professional/certificates">{t("open_certificates")}</Link>
        </Button>
      </div>
    </div>
  );
