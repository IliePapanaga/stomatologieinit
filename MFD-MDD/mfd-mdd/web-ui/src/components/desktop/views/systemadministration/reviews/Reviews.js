...
class Reviews extends BaseView {
    initView(props) {
        let me = this;
        let configuration = {
            requestInfo: {
            ...
            actions: [
                ...
                { label: "Impersonate", onClick: me.onImpersonate },
...
const ReviewsConnector = connect(
    baseViewStateMap,
    baseViewDispatcherMap)(Reviews);

export default ReviewsConnector;