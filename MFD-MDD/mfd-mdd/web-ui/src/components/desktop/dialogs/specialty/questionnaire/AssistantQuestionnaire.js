...
let AssistantQuestionnaire = props => {
        ...
        <form onSubmit={handleSubmit}>
            <div class="quest__dds-main modal48">
                <div class="quest__main-item-wrapper">
                    ...
                    <div class="quest__main-item quest__main-item-textarea first">
                        <div class="item__box">
                            <div class="text">
                    ...
                    <div class="quest__main-item quest__main-item-gray quest__main-item-check-wrapper">
                        <div class="header">What specialties are you familiar with?</div>
                    ...
                    <div class="quest__main-item quest__main-item-textarea">
                        <div class="item__box">
                            <div class="text">
                    ...
                    <div class="quest__main-item quest__main-item-gray quest__main-item-check-overlay">
                        <div class="header">What duties are you confident in?</div>
                    ...
                    <div class="quest__main-item">
                        <div class="radio">
                            ...
                            <div class="item__radio">
                                <div class="item__radio-header">Are you familiar with 3d imaging?</div>
                                <div class="item__radio-wrapper">
                                    <div class="item__radio-content">
                                        <Field name="managedObject.imaging3D" component={Checkbox} disabled={readOnly}/>
                                    </div>
                                </div>
                            </div>

                            <div class="item__radio">
                                <div class="item__radio-header">Are you familiar with Cephelometric XRay mashines?</div>
                                <div class="item__radio-wrapper">
                                    <div class="item__radio-content">
                                        <Field name="managedObject.xray" component={Checkbox} disabled={readOnly}/>
                                    </div>
                                </div>
                            </div>

                            <div class="item__radio">
                                <div class="item__radio-header">Are you familiar with Nomad?</div>
                                <div class="item__radio-wrapper">
                                    <div class="item__radio-content">
                                        <Field name="managedObject.nomad" component={Checkbox} disabled={readOnly}/>
                                    </div>
                                </div>
                            </div>
...
AssistantQuestionnaire = reduxForm({
    form: 'questionnaire'
})(AssistantQuestionnaire);

export default AssistantQuestionnaire;