...
import {TEXTFIELD_DIGITS_PATTERN_REGEX} from "../../../../utils/Constants";
import DateHelper from "../../../../utils/DateHelper";

// TODO 2018-12-13 : review this class
class AdditionalAssistantInfoPage extends CertificateInfoPage {
    ...
    initTemplate(handleSubmit, handleCancel, uploadOptions, managedObject, dialog, allowUpload, readOnly, scope, invalid, change) {
        ...
        managedObject.certificateDetails.certificateType = {id: managedObject.certificate.type};
            ...
            <div class="specialties__second-main">
                ...
                {me.licenseInfo && <div class="item__box">
                    ...
                    <div class="input__long-spec">
                        <Field name="managedObject.certificateDetails.licenseNumber" component={TextField} minLength={1} regexPattern={TEXTFIELD_DIGITS_PATTERN_REGEX}
...
export default AdditionalAssistantInfoPage