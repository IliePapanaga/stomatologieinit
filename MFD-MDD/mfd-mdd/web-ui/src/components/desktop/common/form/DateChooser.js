...
var Day = function (_React$Component) {
    ...
    function Day() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleClick = function (event) {
        ...
        }, _this.hasTimes = function () {
            var _this$props = _this.props,
                zonedJobDays = _this$props.zonedJobDays,
                hasTimes = zonedJobDays != null && zonedJobDays.length > 0;
            ...
            var _this$props = _this.props,
                ...
                zonedJobDays = _this$props.zonedJobDays,
                hasTimes = zonedJobDays != null && zonedJobDays.length > 0,
                serverFormattedDay=hasTimes?day.format(serverShortDateFormat):undefined,
                currentZonedJobDay=hasTimes?zonedJobDays.find(zonedJobDay=>zonedJobDay.date===serverFormattedDay):undefined;

            return currentZonedJobDay?{startTime: DateHelper.convertServerDateStringToString(currentZonedJobDay.startTime,'hh:mm A'),endTime: DateHelper.convertServerDateStringToString(currentZonedJobDay.endTime,'hh:mm A')}:undefined
            ...
            return classnames("react-datepicker__day", _this.hasTimes()?"with_times":"", _this.hasTimes()&&times?"":"without__time", dayClassName,  "react-datepicker__day--" + getDayOfWeekCode(_this.props.day), {
    ...
    Day.prototype.render = function render() {
        ...
        return React.createElement(
            ...
            this.hasTimes()&&times?([getDate(this.props.day),<div class="calendar__time"><div class="calendar__time-item">Start: {times.startTime}</div><div class="calendar__time-item">End: {times.endTime}</div></div>]):getDate(this.props.day)
        );
    };
...
class DateChooser extends DatePicker {
    constructor(props) {
        super(props);
        let _this = this;
        this.renderDateInput = function (date, event, keepInput) {
            var _this = this;
            var _classnames, _React$cloneElement;

            var className = classnames(this.props.class, (_classnames = {}, _classnames[outsideClickIgnoreClass] = _this.state.open, _classnames));

            var customInput = _this.props.customInput || React.createElement("input", {type: "text"});
            var customInputRef = _this.props.customInputRef || "ref";
            //var inputValue = typeof _this.props.value === "string" ? _this.props.value : typeof _this.state.inputValue === "string" ? _this.state.inputValue : this.safeDateFormat(_this.props.selected, _this.props);
            var inputValue = typeof _this.props.value === "string" ? _this.props.value : typeof _this.state.inputValue === "string" ? _this.state.inputValue : this.safeDateFormat(_this.props.selected, _this.props);

            inputValue = DateHelper.convertServerDateStringToString(inputValue, _this.props.dateFormat) || _this.props.placeholder;
            return React.cloneElement(customInput, (_React$cloneElement = {}, _React$cloneElement[customInputRef] = function (input) {
                if (input) {
                    _this.input = input;
                } else {
                    _this.input.value = _this.props.placeholder;
                }
        ...
        let baseRenderCalendar = _this.renderCalendar;
