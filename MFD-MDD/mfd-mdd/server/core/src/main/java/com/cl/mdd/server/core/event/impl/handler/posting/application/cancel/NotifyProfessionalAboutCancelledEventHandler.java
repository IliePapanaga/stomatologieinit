...
@Consumer
public class NotifyProfessionalAboutCancelledEventHandler implements EventHandler<JobPostingApplicationCancelledEvent> {
    ...
    @NotificationDefinition(value = JOB_POSTING_APPLICATION_CANCELLED_FOR_PROFESSIONAL,
            predefined = {
    ...
    public void onEvent(JobPostingApplicationCancelledEvent event, long sequence, boolean endOfBatch) {
        ...
        if (professional.isNotificationsEnabled() && !professional.getStatus().equalsIgnoreCase(User.INACTIVE)) {
            ...
            notification.setType(JOB_POSTING_APPLICATION_CANCELLED_FOR_PROFESSIONAL);
