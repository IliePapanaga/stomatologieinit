...
import static com.cl.mdd.server.core.data.persistent.model.posting.temporary.TemporaryJobPosting.JOB_DAY_STRATEGY_WEEKLY;

public class WeeklyTemporaryJobPosting extends PublishWeeklyTemporaryJobPosting {
    ...
    public String getJobDayStrategy() {
        return JOB_DAY_STRATEGY_WEEKLY;
    }
}
