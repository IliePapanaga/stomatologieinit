...
public class JobPostingApplicationCreatedEvent extends Event {
    ...
    public JobPostingApplicationCreatedEvent setJobPostingApplicationId(String jobPostingApplicationId) {
