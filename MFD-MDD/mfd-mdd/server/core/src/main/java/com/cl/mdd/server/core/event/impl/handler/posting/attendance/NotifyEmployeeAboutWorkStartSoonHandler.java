...
@Consumer
public class NotifyEmployeeAboutWorkStartSoonHandler implements EventHandler<WorkStartSoonEvent> {

    private static final String WORK_START_SOON_FOR_EMPLOYEE = "WORK_START_SOON_FOR_EMPLOYEE";
    ...
    @Override
    @Transactional
    @NotificationDefinition(value = WORK_START_SOON_FOR_EMPLOYEE,
            predefined = {
    ...
    public void onEvent(WorkStartSoonEvent event, long sequence, boolean endOfBatch) {
        ...
        if (day == null || day.isNotifiedAboutStartSoon()) {
            return;
        }
        ...
        if (professional.isNotificationsEnabled() && !professional.getStatus().equalsIgnoreCase(User.INACTIVE)) {
            ...
            notification.setType(WORK_START_SOON_FOR_EMPLOYEE);
            ...
            jobPostingApplicationEndDateTimeVariables.supply(temporaryJobPostingApplication, context);
